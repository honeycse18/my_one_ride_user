...
import 'package:one_ride_user/controller/home_navigator_screen_controller/chat_screen_controller.dart';
    ...
    return GetBuilder<ChatScreenController>(
        ...
        builder: (controller) => Scaffold(
              ...
              appBar: CoreWidgets.appBarWidget(
                ...
                titleWidget: Text(controller.getUser.name),
                actions: [
                  SuperTooltip(
                    content: Column(
              ...
              bottomNavigationBar: Padding(
                ...
                child: CustomTextFormField(
                  ...
                  hintText: AppLanguageTranslation
                      .enterTextTransKey.toCurrentLanguage,
